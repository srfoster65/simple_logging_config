...
options:
  ...
  --slc-backup-count SLC_BACKUP_COUNT
                        An integer specifying The number of backup log files to retain.
  --slc-config {default,detailed,console,file}
